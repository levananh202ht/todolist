...
class App extends React.Component {
  constructor(props){
    ...
    this.state = {
      todolist: [
        {id: 1, name: "anh", isCompleted: true },
      ...
      <div className='container'>
        ...
        <div className='main'>
          <div className='content'>
            ...
            <ContentList onEditItem = {this.onEditItem} todolist = {todolist} deleteItem = {this.deleteItem} getTodoEditing={this.getTodoEditing} todoEditing={todoEditing} />
            <Footer />
          </div>
        </div>
      </div>
