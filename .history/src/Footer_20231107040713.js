...
const Footer = (deleteAll,handleAllClick,countedLeft,CompletedFooter,handleActiveClick,handleCompletedClick,countClick) => {
    return(            
        <div className='Footer'>
            <p className='iteam' onClick={countClick}>{countedLeft} iteams left</p>
