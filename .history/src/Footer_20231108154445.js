...
const Footer = ({todolist,filtere,deleteAll,setFilter}) => {
    ...
    return(            
        <div className='Footer'>
            ...
            <div className='filters'>
                <button
                    className={`${filtere === newFilter.All ? 'selected' : ''}`}
                    onClick={() => handleFilter(newFilter.All)}
                >
                    All
                </button>
                <button 
                    className={`${filtere === newFilter.Active ? "selected" : ''}`}
                    onClick={() => handleFilter(newFilter.Active)}
                >
                    Active  
                </button>
                <button
                    className={`${filtere === newFilter.Completed ? "selected" : ''}`}
