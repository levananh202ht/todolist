...
class Footer extends React.Component{
    ...
    render(){
        const {deleteAll,filter} = this.props;
        ...
        return(            
            <div className='Footer'>
                ...
                <div className='filters'>
                    <button
                        className={`${CompletedFooter === filter.All ? 'selected' : ''}`}
                        onClick={handleAllClick}
                    >
                        All
                    </button>
                    <button 
                        className={`${CompletedFooter === filter.Active ? "selected" : ''}`}
                        onClick={handleActiveClick}
                    >
                        Active  
                    </button>
                    <button
                        className={`${CompletedFooter === filter.Completed ? "selected" : ''}`}
